...
@section('head')
    ...
    <style>
        ...
        #hl-list::-webkit-scrollbar {
            width: 4px;
        }

        #hl-list::-webkit-scrollbar-track {
...
=======
        ...
        .snc-details summary::-webkit-details-marker {
            display: none;
        }

        .snc-details summary:hover {
            background: var(--border);
        }
        ...
        .snc-details[open] summary .snc-arrow {
        ...
        .ai-stack summary::-webkit-details-marker {
            display: none;
        }

        .ai-stack summary::after {
            content: '▼';
            font-size: 0.8em;
            color: var(--text-muted);
            transition: transform 0.2s;
        ...
        .ai-stack details[open] summary::after {
            transform: rotate(180deg);
        }

        .ai-stack summary:hover {
            background: var(--bg-hover, #e2e6ea);
        }

        .ai-stack .details-content {
            padding: 15px;
            font-size: 0.95em;
            line-height: 1.6;
            color: var(--text-primary);
        ...
        .md-card-pronounce .md-card-title {
            color: #ed4245;
        }
        ...
        .md-vocab-list li:last-child {
            border-bottom: none;
            padding-bottom: 0;
        }

        .md-vocab-list strong {
            color: var(--primary);
            font-weight: 700;
            font-size: 1.05em;
        }
...
@section('body')
    <div class="reader-layout" data-document-id="{{ $document_id }}">
        ...
        <header class="reader-topbar">
            ...
            <div class="topbar-center">
                <div class="page-control">
                    <button class="page-btn" id="prev-page-btn"><svg width="14" height="14" fill="none"
                    ...
                    <button class="page-btn" id="next-page-btn"><svg width="14" height="14" fill="none"
                            stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
            ...
            <div class="topbar-right">
                <button class="icon-btn" id="toggle-highlights-btn" title="Sembunyikan Stabilo"><svg width="18" height="18"
                        fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                        <circle cx="12" cy="12" r="3"></circle>
                    </svg></button>
                <button class="icon-btn" id="start-focus-btn" title="Mode Fokus"><svg width="18" height="18" fill="none"
                        stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path
                            d="M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3">
                        </path>
                    </svg></button>
                <button class="icon-btn" id="highlights-toggle-btn" title="Catatan AI"><svg width="16" height="16"
                        fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path d="M12 20h9" />
        ...
        <div class="reader-body">
            <aside class="highlights-sidebar" id="highlights-sidebar">
                <div class="hl-sidebar-header">
                    ...
                    <button id="delete-all-notes-btn" class="icon-btn" style="color: var(--danger);"><svg width="18"
            ...
            <div class="pdf-area" id="pdf-area">
                <div class="pdf-loading" id="pdf-loading">
                    <div class="loading-dot-wrap"><span class="loading-dot"></span><span class="loading-dot"></span><span
                            class="loading-dot"></span></div>
                </div>
            ...
            <aside class="ai-panel" id="ai-panel" hidden>
                ...
                <div class="ai-panel-header">
                    ...
                    <button class="ai-panel-close" id="ai-panel-close"><svg width="18" height="18" fill="none"
                            stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <div class="selection-tooltip" id="selection-tooltip" hidden>
            <button class="tooltip-btn" id="analyze-btn" title="AI Analysis">
