...
<head>
    ...
    <title>@yield('title', 'Readfolio')</title>
   ...
   <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    ...
    <style>
        /* CSS UNTUK WELCOME OVERLAY */
        #welcome-overlay { position: fixed; inset: 0; z-index: 9999; background: rgba(0, 0, 0, 0.55); backdrop-filter: blur(14px); -webkit-backdrop-filter: blur(14px); display: flex; align-items: center; justify-content: center; opacity: 0; transition: opacity 0.5s ease; pointer-events: none; }
        #welcome-overlay.visible { opacity: 1; pointer-events: auto; }
        #welcome-text { text-align: center; font-family: 'Cormorant Garamond', 'Palatino Linotype', Georgia, serif; font-style: italic; font-weight: 300; color: #fff; line-height: 1.5; letter-spacing: 0.03em; animation: welcome-rise 0.7s cubic-bezier(0.22, 1, 0.36, 1) both; }
        #welcome-text .line1 { display: block; font-size: clamp(18px, 3.5vw, 28px); color: rgba(255,255,255,0.72); margin-bottom: 6px; }
